...
public class MAXTalonSwerveMotors extends SubsystemBase {
  private static MAXTalonSwerveMotors instance;
  private static boolean running;

  public static MAXTalonSwerveMotors getInstance() {
    if (instance == null) instance = new MAXTalonSwerveMotors();
    return instance;
  }
